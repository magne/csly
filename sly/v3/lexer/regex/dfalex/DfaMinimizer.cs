    ...
    internal class DfaMinimizer<TResult>
    {
        ...
        private void CreateNewStates()
        {
            ...
            foreach (var statenum in partitionOrderStates)
            {
                ...
                System.Diagnostics.Debug.Assert(partnum == minStates.Count);
        ...
        private void _repartition(int start, int end)
        {
            ...
            System.Diagnostics.Debug.Assert(totalLen == end - start);
            ...
            for (var bucketStart = 0; bucketStart < totalLen;)
            {
                ...
                System.Diagnostics.Debug.Assert(destpos == bucketStart + start);
            ...
            System.Diagnostics.Debug.Assert(destpos == end);
